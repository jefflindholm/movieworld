...
/***/ function(module, exports, __webpack_require__) {
	...
	var _movieList = __webpack_require__(169);
	
	var _movieList2 = _interopRequireDefault(_movieList);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_reactDom2.default.render(_react2.default.createElement(_movieList2.default, {
	  __self: undefined
	}), document.getElementById('container')); // client/client.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _movieInfo = __webpack_require__(170);
	
	var _movieInfo2 = _interopRequireDefault(_movieInfo);
	
	var _movieForm = __webpack_require__(171);
	...
	var MovieList = function (_React$Component) {
	    ...
	    function MovieList() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MovieList).call(this));
	        ...
	        _this.moviesUpdated = function () {
	            fetch('http://localhost:3000/movie', {
	                ...
	                _this.setState({ movies: json });
	            });
	            _this.setState({ movie: null });
	        };
	
	        _this.movieClicked = function (movie) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-6', __self: this
	                    },
	                    _react2.default.createElement(_movieForm2.default, _extends({}, this.state.movie, { onChanges: this.moviesUpdated, __self: this
	                    }))
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-6', style: listStyle, __self: this
	                    },
	                    this.state.movies.map(function (movie, idx) {
	                        var selected = _this2.state.movie ? movie.id === _this2.state.movie.id : false;
	                        return _react2.default.createElement(_movieInfo2.default, { movie: movie, key: 'movie-' + idx, selected: selected, onClick: _this2.movieClicked, __self: _this2
	                        });
	                    })
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // client/components/movie-info.js
	...
	var MovieInfo = function (_React$Component) {
	    ...
	    function MovieInfo() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MovieInfo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onClick = function () {
	            console.log('clicked');
	            _this.props.onClick(_this.props.movie);
	    ...
	    _createClass(MovieInfo, [{
	        key: 'render',
	        value: function render() {
	            var className = 'panel ' + (this.props.selected ? 'panel-primary' : 'panel-default');
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'panel-heading', onClick: this.onClick, __self: this
	                    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSelectPlus = __webpack_require__(172);
	
	var _reactSelectPlus2 = _interopRequireDefault(_reactSelectPlus);
	
	var _numberInput = __webpack_require__(181);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // client/components/movie-form.js
	...
	var MovieForm = function (_React$Component) {
	    ...
	    function MovieForm() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MovieForm).call(this));
	
	        _this.save = function () {
	            var movie = {
	                title: _this.state.title,
	                duration: _this.state.duration,
	                movieRatingId: _this.state.selectedRating.value,
	                genres: _this.state.selectedGenres.map(function (g) {
	                    return g.value;
	                })
	            };
	            ...
	            if (_this.state.action === 'ADD') {
	                verb = 'POST';
	            } else if (_this.state.action === 'UPDATE') {
	                verb = 'PATCH';
	            }
	            fetch('http://localhost:3000/movie', {
	                method: verb,
	        ...
	        _this.valueChange = function (val) {
	            _this.setState({ duration: val });
	        };
	
	        _this.ratingSelected = function (val) {
	            _this.setState({ selectedRating: val });
	        };
	
	        _this.genreSelected = function (val) {
	            _this.setState({ selectedGenres: val });
	        };
	    ...
	    _createClass(MovieForm, [{
	        ...
	        value: function componentWillReceiveProps(newProps) {
	            ...
	            var selectedRating = this.state.ratings.find(function (i) {
	                return i.value === newProps.movieRatingId;
	            });
	            var selectedGenres = newProps.genres.map(function (g) {
	                return _this2.state.genres.find(function (genre) {
	                    return g.genreId === genre.value;
	                });
	            });
	            this.setState({
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch('http://localhost:3000/movie_rating', {
	                ...
	                var ratings = json.map(function (rating) {
	                    return { label: rating.ratingCode + ' - ' + rating.description, value: rating.id };
	                });
	                _this3.setState({ ratings: ratings });
	            });
	            fetch('http://localhost:3000/genre', {
	                ...
	                var genres = json.map(function (genre) {
	                    return { label: genre.name, value: genre.id };
	                });
	                _this3.setState({ genres: genres });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        { className: 'control-label', htmlFor: 'movieTitle', __self: this
	                        },
	                        'Title:'
	                    ),
	                    _react2.default.createElement('input', { type: 'text',
	                        ...
	                        placeholder: 'Enter Movie Title', __self: this
	                    })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        { className: 'control-label', htmlFor: 'movieDuration', __self: this
	                        },
	                        'Duration:'
	                    ),
	                    _react2.default.createElement(_numberInput2.default, {
	                        ...
	                        placeholder: 'Minutes', __self: this
	                    })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        { className: 'control-label', htmlFor: 'ratingList', __self: this
	                        },
	                        'Rating:'
	                    ),
	                    _react2.default.createElement(_reactSelectPlus2.default, { name: 'ratingList',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        { className: 'control-label', htmlFor: 'genreList', __self: this
	                        },
	                        'Genres:'
	                    ),
	                    _react2.default.createElement(_reactSelectPlus2.default, { name: 'genreList',
	                        multi: true,
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { style: { marginRight: '10px' }, className: 'btn btn-default', onClick: this.save, __self: this
	                        },
	                        'Save'
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { style: { marginRight: '10px' }, className: 'btn btn-default', onClick: this.clear, __self: this
	                        },
	                        'Clear'
	                    )
	                )
	...
	MovieForm.propTypes = {
	    onChanges: _react2.default.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStripDiacritics = __webpack_require__(175);
	
	var _utilsStripDiacritics2 = _interopRequireDefault(_utilsStripDiacritics);
	
	var _Async = __webpack_require__(176);
	...
	var _OptionGroup = __webpack_require__(179);
	
	var _OptionGroup2 = _interopRequireDefault(_OptionGroup);
	
	var _Value = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberInput = function (_React$Component) {
	    ...
	    function NumberInput() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(NumberInput)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onKeyDown = function (e) {
	            if (e.which === 38) {
	                console.log('up');
	                // UP
	                e.preventDefault();
	                var value = Math.min(_this.props.value + _this.props.step, _this.props.max);
	                _this.props.onValueChange(value);
	            } else if (e.which === 40) {
	                console.log('down');
	                // DOWN
	                e.preventDefault();
	                var _value = Math.max(_this.props.value - _this.props.step, _this.props.min);
	                _this.props.onValueChange(_value);
	            } else {
	                // keyCode?
	                // backspace, delete, tab, enter, esc, and .
	                var codes = [46, 8, 9, 13, 27, 110, 190];
	    ...
	    _createClass(NumberInput, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement('input', { className: this.props.className,
	                ...
	                value: this.props.format(this.props.value), __self: this
	            });
	        }
	    }]);
